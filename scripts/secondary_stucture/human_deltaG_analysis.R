...
# constitutive events
CS_donor = read.csv('/home/bia/sugarcane_introns_local/data/Human_genome/generated/features/ALL_hg18_human_CS_donor.csv')
CS_acceptor = read.csv('/home/bia/sugarcane_introns_local/data/Human_genome/generated/features/ALL_hg18_human_CS_acceptor.csv')

# ALTA events
ALTD_donor = read.csv('/home/bia/sugarcane_introns_local/data/Human_genome/generated/features/ALL_hg18_human_ALTD_donor.csv')

# ALTD events
ALTA_acceptor = read.csv('/home/bia/sugarcane_introns_local/data/Human_genome/generated/features/ALL_hg18_human_ALTA_acceptor.csv')

# INT events
INT_donor = read.csv('/home/bia/sugarcane_introns_local/data/Human_genome/generated/features/ALL_hg18_human_INT_donor.csv')
INT_acceptor = read.csv('/home/bia/sugarcane_introns_local/data/Human_genome/generated/features/ALL_hg18_human_INT_acceptor.csv')

# EX events
EX_donor = read.csv('/home/bia/sugarcane_introns_local/data/Human_genome/generated/features/ALL_hg18_human_EXsk_donor.csv')
EX_acceptor = read.csv('/home/bia/sugarcane_introns_local/data/Human_genome/generated/features/ALL_hg18_human_EXsk_acceptor.csv')
...
# ALTD events VS constitutive (donor)
...
# ALTA events VS constitutive (acceptor)
...
# INT events VS constitutive () acceptor)
...
# EX events VS constitutive (acceptor)
