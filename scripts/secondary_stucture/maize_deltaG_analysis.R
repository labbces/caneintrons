...
###############################
### ANALYSIS FOR MAIZE DATA ###
###############################

### LOADING CSV FILES - from step 4 ###
# constitutive events
CS_donor = read.csv('/home/bia/sugarcane_introns_local/data/maize/generated/features/ALL_2017v31_maize_CS_donor.csv')
CS_acceptor = read.csv('/home/bia/sugarcane_introns_local/data/maize/generated/features/ALL_2017v31_maize_CS_acceptor.csv')

# ALTA events
ALTD_donor = read.csv('/home/bia/sugarcane_introns_local/data/maize/generated/features/ALL_2017v31_maize_ALTD_donor.csv')

# ALTD events
ALTA_acceptor = read.csv('/home/bia/sugarcane_introns_local/data/maize/generated/features/ALL_2017v31_maize_ALTA_acceptor.csv')

# INT events
INT_donor = read.csv('/home/bia/sugarcane_introns_local/data/maize/generated/features/ALL_2017v31_maize_INT_donor.csv')
INT_acceptor = read.csv('/home/bia/sugarcane_introns_local/data/maize/generated/features/ALL_2017v31_maize_INT_acceptor.csv')

# EX events
EX_donor = read.csv('/home/bia/sugarcane_introns_local/data/maize/generated/features/ALL_2017v31_maize_EXsk_donor.csv')
EX_acceptor = read.csv('/home/bia/sugarcane_introns_local/data/maize/generated/features/ALL_2017v31_maize_EXsk_acceptor.csv')
